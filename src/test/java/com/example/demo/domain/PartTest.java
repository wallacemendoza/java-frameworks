...
class PartTest {
    ...
    // ✅ New Tests for Task I
    @Test
    void testMinMaxInventoryValid() {
        partIn.setMinInv(1);
        partIn.setMaxInv(10);
        partIn.setInv(5);
    ...
    @Test
    void testMinMaxInventoryInvalid() {
        partIn.setMinInv(1);
        partIn.setMaxInv(5);
        partIn.setInv(10);
        assertFalse(partIn.getInv() >= partIn.getMinInv() && partIn.getInv() <= partIn.getMaxInv());
    }
}
